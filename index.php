        ...
        <?
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "SORT_ORDER2" => "ASC",
                    "STRICT_SECTION_CHECK" => "N",
                    "COMPONENT_TEMPLATE" => "main_services_custom_template"
                ),
                false
            );
        ?>
...
<section class="wrapper style2">
    <div class="container">
        <header class="major">
            <h2>Наш торговый каталог</h2>
            <p>Новинки и свежие поступления</p>
        </header>
    </div>
</section>
        ...
        <?
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "SORT_ORDER2" => "ASC",
                    "STRICT_SECTION_CHECK" => "N",
                    "COMPONENT_TEMPLATE" => "main_goods_custom_template"
                ),
                false
            );
        ?>
